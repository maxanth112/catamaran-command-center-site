const SOURCES = {
  ...
  dolphin460: 'https://www.multihullcompany.com/boat/dolphin-460-10164723/',
...
const PROFILES = [
  ...
  { pattern: /dolphin\s*460/i, performance: 8.8, offshore: 9.0, comfort: 8.2, passageSpeed: '7–9.5 kn', source: SOURCES.dolphin460, note: 'Daggerboards, foam-cored composite construction and relatively lean hulls make the Dolphin 460 a genuine performance-bluewater design while retaining a practical owner-layout cruising interior.' },
